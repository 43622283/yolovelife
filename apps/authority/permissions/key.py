...
class KeyListRequiredMixin(KeyAPIRequiredMixin):
    permission_required = u'authority.deveops_api_list_key'


class KeyCreateRequiredMixin(KeyAPIRequiredMixin):
    permission_required = u'authority.deveops_api_create_key'


class KeyUpdateRequiredMixin(KeyAPIRequiredMixin):
    permission_required = u'authority.deveops_api_update_key'


class KeyDeleteRequiredMixin(KeyAPIRequiredMixin):
    permission_required = u'authority.deveops_api_delete_key'
